...
class lightHouseCrawler {
  ...
  async run() {
    ...
    for(const entry of entries) {
      ...
      if(auth) {
        log('--------------------auth-------------')
        await this.login(page, url, category, subcategory);
      }else {
        log('--------------------no-------------', url)
        await this.explorer(page, url, category, subcategory);
      }
    }
  ...
  async login(page, url, category, subcategory) {
  ...
  async explorer(page, url, category, subcategory) {
    log('---------------------explorer-start--------------------');
